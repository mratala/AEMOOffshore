...
// -----( CREATED: 2004-04-21 23:07:09 PDT
// -----( ON-HOST: 192.168.0.4
...

{
        ...
        throws ServiceException
	{
		...
		/** Service replaces pub.math:addFloats, as that service suffers from issues
		  ...
		  * 
		  * Any errors encountered will cause a com.wm.app.b2b.server.ServiceException to be 
		  * thrown.
		  * 
		  * **NOTE**: Empirical evidence shows that results may begin to lose their reliability
		  * at larger scales. Scales lower than 10 seem to work fine in limited testing.
		  *
		...
		{
			throw new ServiceException("The input variable \"number1\" must be a float or "
							+ "a double.");
		}
		...
		{
			throw new ServiceException("The input variable \"number2\" must be a float or "
							+ "a double.");
		}
		...
		else
		{
			...
			{
				throw new ServiceException("The input variable \"scale\" must be an "
								+ "integer.");
			}
		}
		
		//Create the BigDecimal objects representing the numbers that were provided.
