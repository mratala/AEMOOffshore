...
// -----( CREATED: 2010-11-25 18:44:59 CET
// -----( ON-HOST: FRPARWMAP01.ema.priv.rhodia.com
...

{
	...
	public static final void trimZeroString (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(trimZeroString)>> ---
		// @subtype unknown
		// @sigtype java 3.5
		// [i] field:0:required input
		...
		for ( i-=1; i < input.length();output = output + input.charAt(i++));
		}
		...
		pipelineCursor.insertAfter("output", output);
		pipelineCursor.destroy();
		// --- <<IS-END>> ---
