...
// -----( CREATED: 2014-10-13 19:43:39 IST
// -----( ON-HOST: vm-solvay.eur.ad.sag
...

{
	...
	public static final void calculateDateDiff (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(calculateDateDiff)>> ---
		// @subtype unknown
		// @sigtype java 3.5
		...
		// [o] field:0:required Sec
		// [o] field:0:required Min
		// [o] field:0:required Hr
		// [o] field:0:required Day
		...
		timediff = timediff % 60000;
				...
				pipelineCursor_1.insertAfter( "Sec", displayTimeSec);
				pipelineCursor_1.insertAfter( "Min", displayTimeMin);
				pipelineCursor_1.insertAfter( "Hr", displayTimeHr);
				pipelineCursor_1.insertAfter( "Day", displayTimeDay);
	...
	public static final void calculateDateDiffMS (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(calculateDateDiffMS)>> ---
		// @subtype unknown
		// @sigtype java 3.5
		// [i] field:0:required startDateTime
		// [i] field:0:required endDateTime
		...
		try {
				...
				SimpleDateFormat edf = new SimpleDateFormat(endDateFormat);
				Date edt = edf.parse(endDateTime);
				Long  Ltimediff = edt.getTime() - sdt.getTime();
		                String timediff = Long.toString(Ltimediff);  
				...
				IDataCursor pipelineCursor_1 = pipeline.getCursor();
				pipelineCursor_1.last();
				pipelineCursor_1.insertAfter( "TimeDiffMS", timediff);
	...
	public static final void divideTime (IData pipeline)
        throws ServiceException
	{
		// --- <<IS-START(divideTime)>> ---
		// @subtype unknown
		// @sigtype java 3.5
		// [i] field:0:required sumDay
		// [i] field:0:required sumHour
		// [i] field:0:required sumMin
		...
		if (pipelineCursor.first("sumDay"))
		{
			sday = (String) pipelineCursor.getValue();
		}
		
		if (pipelineCursor.first("sumHour"))
		{
			sHour = (String) pipelineCursor.getValue();
		}
		
		if (pipelineCursor.first("sumMin"))
		{
			sminute = (String) pipelineCursor.getValue();
		}
		if (pipelineCursor.first("divisor"))
		{
			sdiv = (String) pipelineCursor.getValue();
		}
		
		if (sdiv.equals("") || sdiv.equals("0"))
		...
		iminute=Integer.parseInt(sminute);
		 ...
		 idiv=Integer.parseInt(sdiv);
		
		pipelineCursor.destroy();
		
		try {
		
		sec= (iday * 86400) + (iHour*3600) + (iminute*60);
		
		sec/=idiv;
		
		String displayTimeDay = Long.toString(sec/86400);
		
		sec = sec % 86400;
		
		String displayTimeHr = Long.toString(sec/3600);
		sec = sec % 3600;
				String displayTimeMin = Long.toString(sec/60);
		sec = sec % 60;
				String displayTimeSec = Long.toString(sec);
